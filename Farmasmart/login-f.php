...
<div class="container-fluid" align="center" style="padding:100px" >
    ...
    <form class="form-signin"  action="profile-f.php"  method="post">
...
<!--  <button class="btn btn-lg btn-success btn-block" type="submit" name="submit" >Login</button>-->
      <button class="btn btn-lg btn-success btn-block" type="submit" name="submit" href="profile-f.php" >Login as Farmer</button>
